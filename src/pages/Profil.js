        ...
        <div className="p-6">
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-6 flex flex-col items-center">
              <div className="w-32 h-32 rounded-full overflow-hidden border-4 border-[#82674a] mb-4">
                <img 
            ...
            {/* Input Nama */}
            <div className="mb-4">
              <label className="block text-[#82674a] font-medium mb-2">Nama</label>
              <input
                type="text"
                name="name"
                value={formData.name}
            ...
            {/* Input Email */}
            <div className="mb-4">
              <label className="block text-[#82674a] font-medium mb-2">Email</label>
              <input
                type="email"
                name="email"
            ...
            {/* Input No HP */}
            <div className="mb-4">
              <label className="block text-[#82674a] font-medium mb-2">No HP</label>
              <input
                type="text"
                name="phone"
            ...
            {/* Input Alamat */}
            <div className="mb-6">
              <label className="block text-[#82674a] font-medium mb-2">Alamat</label>
              <input
                type="text"
                name="address"
            ...
            <div className="mb-6 border-t border-gray-300 pt-6">
              ...
              <div className="mb-4">
                <label className="block text-[#82674a] font-medium mb-2">Password Lama</label>
                <input
                  type="password"
              ...
              <div className="mb-4">
                <label className="block text-[#82674a] font-medium mb-2">Password Baru</label>
                <input
                  type="password"
                  name="newPassword"
              ...
              <div className="mb-6">
                <label className="block text-[#82674a] font-medium mb-2">Konfirmasi Password Baru</label>
                <input
                  type="password"
            ...
            <div className="flex justify-center">
              <button
                type="submit"
                className="bg-[#82674a] text-white py-2 px-4 rounded hover:bg-[#6d5738]"
              >
                Update Profil
              </button>
            </div>
